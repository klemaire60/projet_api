			...
			<header>
				<div class='navbar'>
					...
					<div class='page'>		
						...
						/*echo"
						<a href='index.php?p=3 ème'><div";
						if(isset($_GET['p'])&& $_GET['p']=='3 ème')
						{
							echo" class='active' style='background-color:#5dc6b8'";
						}
						else
						{
							echo" class='link' style='background-color:#5dc6b8'";
						}
						echo"><i class='fa fa-cogs' aria-hidden='true'></i> 3 ème
						</div>
						</a>*/
						echo"
				...
				echo"<div id='page'>
						<div class='mention'>
							<h3> Mentions Légales</h3>
								...
								<center><a href='http://www.la-providence.net/' target='_blank'><img src='assets/img/logo_providence.jpg' width=20%;></a></Center>
						</div>
					</div>
				...
				<div id='page'>
					...
					echo"
						<div class='p_cours'style='margin-bottom:8%'>";
							...
							{
								echo"
						<center><iframe src='assets/ressource/pdf_cours/error.pdf' width='90%' height='800VW'></iframe></center>
					...
					{
						echo"
						<div class='p_cours' style='margin-bottom:8%'><center><iframe src='assets/ressource/pdf_cours/error.pdf' width='90%' height='800VW'></iframe></center>
